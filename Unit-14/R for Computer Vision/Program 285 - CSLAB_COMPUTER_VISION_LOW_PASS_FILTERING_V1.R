...
File Name       :   CSLAB_COMPUTER_VISION_LOW_PASS_FILTERING_V1
Purpose 	:   A Program for Apply Low Pass Filtering on an Image in Computer Vision in R
Author		:   Durga Prasad
Reviewer 	:   Jothi Periasamy
Date and Time	:   23/01/2019 11:33 hrs
Version		:   1.0	
Change History 	: 
...
## Program Description : A Program for Apply Low Pass Filtering on an Image in Computer Vision in R
...
vAR_CSLAB_flo = makeBrush(21, shape='disc', step=FALSE)^2

vAR_CSLAB_flo = vAR_CSLAB_flo/sum(vAR_CSLAB_flo)

vAR_CSLAB_imgflo = filter2(vAR_CSLAB_Image, vAR_CSLAB_flo)

display(vAR_CSLAB_imgflo)
