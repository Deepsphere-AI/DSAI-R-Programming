...
File Name       :   CSLAB_COMPUTER_VISION_COLOR_MANAGEMENT_V1
Purpose 	:   A Program for Color Management in Computer Vision in R
Author		:   Durga Prasad
Reviewer 	:   Jothi Periasamy
Date and Time	:   23/01/2019 11:18 hrs
Version		:   1.0	
Change History 	: 
...
## Program Description : A Program for Color Management in Computer Vision in R
