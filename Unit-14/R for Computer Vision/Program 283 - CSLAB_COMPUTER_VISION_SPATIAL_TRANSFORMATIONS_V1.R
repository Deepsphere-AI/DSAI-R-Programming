...
File Name       :   CSLAB_COMPUTER_VISION_SPATIAL_TRANSFORMATIONS_V1
Purpose 	:   A Program for Spatial Transformations on an Image in Computer Vision in R
Author		:   Durga Prasad
Reviewer 	:   Jothi Periasamy
Date and Time	:   23/01/2019 10:55 hrs
Version		:   1.0	
Change History 	: 
...
## Program Description : A Program for Spatial Transformations on an Image in Computer Vision in R
