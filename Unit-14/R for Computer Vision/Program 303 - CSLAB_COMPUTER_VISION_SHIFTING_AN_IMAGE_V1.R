...
File Name       :   CSLAB_COMPUTER_VISION_SHIFTING_AN_IMAGE_V1
Purpose 	:   A Program for Shifting an Image in Computer Vision in R
Author		:   Durga Prasad
Reviewer 	:   Jothi Periasamy
Date and Time	:   24/01/2019 16:05 hrs
Version		:   1.0	
Change History 	: 
...
## Program Description : A Program for Shifting an Image in Computer Vision in R
...
imshift(vAR_CSLAB_Parrots,40,20) %>% plot(main="Shifting")
