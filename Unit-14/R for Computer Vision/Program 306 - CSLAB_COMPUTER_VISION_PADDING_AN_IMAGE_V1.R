...
File Name       :   CSLAB_COMPUTER_VISION_PADDING_AN_IMAGE_V1
Purpose 	:   A Program for Padding an Image in Computer Vision in R
Author		:   Durga Prasad
Reviewer 	:   Jothi Periasamy
Date and Time	:   24/01/2019 16:47 hrs
Version		:   1.0	
Change History 	: 
...
## Program Description : A Program for Padding an Image in Computer Vision in R
...
pad(vAR_CSLAB_Parrots,axes="y",140) %>% plot
