...
File Name       :   CSLAB_COMPUTER_VISION_HISTOGRAM_EQUALIZATION_V1
Purpose 	:   A Program for Histogram Equalization in Computer Vision in R
Author		:   Durga Prasad
Reviewer 	:   Jothi Periasamy
Date and Time	:   23/01/2019 11:57 hrs
Version		:   1.0	
Change History 	: 
...
## Program Description : A Program for Histogram Equalization in Computer Vision in R
...
vAR_CSLAB_y= equalize(vAR_CSLAB_Image) 
